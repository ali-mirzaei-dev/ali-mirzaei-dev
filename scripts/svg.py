...
<text x="290" y="{y}" text-anchor="end" font-size="12" font-family="{font_pro}" fill="#8c959f">{pct}%</text>'''
    ...
    for i, (name, data) in enumerate(top_langs):
        ...
        bar_width = max(4, count / max_repos * right_bar_max_width)
...
<text x="34"
      ...
      fill="#8c959f"
      font-weight="600"
      letter-spacing="1">BY BYTES</text>
...
<text x="344"
      ...
      fill="#8c959f"
      font-weight="600"
      letter-spacing="1">BY REPOS</text>
